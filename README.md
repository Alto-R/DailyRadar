...
| 组件 | 来源 |
|------|------|
| GitHub / YouTube / RSS 采集器 | 改编自 [obsidian-daily-digest](https://github.com/iamseeley/obsidian-daily-digest) |
| AI 摘要 + 偏好学习 | 改编自 [obsidian-daily-digest](https://github.com/iamseeley/obsidian-daily-digest) |
| Docker + supercronic 多调度 | 改编自 [TrendRadar](https://github.com/sansan0/TrendRadar) |
| 飞书 / 企业微信推送 | 改编自 [TrendRadar](https://github.com/sansan0/TrendRadar) |
| Email HTML 模板 | 改编自 [obsidian-daily-digest](https://github.com/iamseeley/obsidian-daily-digest) |
